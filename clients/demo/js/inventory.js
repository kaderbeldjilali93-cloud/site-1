    ...
    <div class="px-6 py-8 animate-fade-in text-white min-h-screen">
        ...
        <div class="flex flex-wrap justify-between items-center mb-8 gap-4">
            ...
            <div class="flex gap-3">
                ...
                <button onclick="window.showInventoryModal()" class="bg-gradient-to-r from-brand-gold to-brand-dark hover:brightness-110 text-emerald-950 font-black py-2.5 px-6 rounded-xl shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-transform active:scale-95 flex items-center gap-2">
