    ...
    try {
        ...
        dynamicContent.innerHTML += `
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div class="operational-stat bg-gray-800 p-5 rounded-2xl border border-gray-700 shadow-lg flex flex-col items-center h-80"><h3 class="text-white font-bold mb-4 w-full flex items-center gap-2">نسب المأكولات</h3><div class="relative w-full h-40"><canvas id="foodChart"></canvas></div></div>
                <div class="operational-stat bg-gray-800 p-5 rounded-2xl border border-gray-700 shadow-lg flex flex-col items-center h-80"><h3 class="text-white font-bold mb-4 w-full flex items-center gap-2">نسب المشروبات</h3><div class="relative w-full h-40"><canvas id="drinkChart"></canvas></div></div>
                <div class="operational-stat bg-gray-800 p-5 rounded-2xl border border-gray-700 shadow-lg h-80"><h3 class="text-white font-bold mb-4">النشاط الزمني</h3><div class="relative w-full h-64"><canvas id="lineChart"></canvas></div></div>
            </div>
        `;
        ...
        const createTable = (title, items) => {
            ...
            return `<div class="operational-stat bg-gray-800 rounded-2xl border border-gray-700 shadow-lg overflow-hidden"><div class="p-4 bg-gray-750 border-b border-gray-700 flex items-center gap-2"><h3 class="text-white font-bold">الأكثر مبيعاً (${title})</h3></div><div class="overflow-x-auto w-full"><table class="w-full text-left text-sm min-w-[300px]"><thead class="bg-gray-900 text-gray-400 uppercase text-xs"><tr><th class="py-3 pl-4">#</th><th class="py-3">المنتج</th><th class="py-3 pr-4 text-right">الكمية</th></tr></thead><tbody>${rows}</tbody></table></div></div>`;
        };
